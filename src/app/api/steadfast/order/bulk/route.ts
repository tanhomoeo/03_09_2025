...
import type { SteadfastBulkOrderItem, SteadfastBulkOrderResultItem } from '@/lib/types';
...
export async function POST(request: Request) {
  try {
    ...
    const result: SteadfastBulkOrderResultItem[] = await bulkCreateOrders(body.data);
