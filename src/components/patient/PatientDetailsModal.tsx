...
const categorizedCaseNotesSchema = z.object({
  ...
  mentalAndEmotionalSymptoms: z.string().optional(),
  excitingCause: z.string().optional(),
  maintainingCause: z.string().optional(),
  familyAndHereditaryHistory: z.string().optional(),
  pastMedicalHistory: z.string().optional(),
  pastTreatmentHistory: z.string().optional(),
});
...
const patientInfoSchema = z.object({
  ...
  registrationDate: z.string().refine(val => val === '' || isValid(new Date(val)), {
    message: 'নিবন্ধনের তারিখ আবশ্যক অথবা খালি রাখুন।',
  }),
  caseNotes: z.string().optional(),
  categorizedCaseNotes: categorizedCaseNotesSchema.optional(),
});
      ...
      <DialogContent className="max-w-lg md:max-w-4xl w-full p-0">
        ...
        >
          <TabsList className="grid w-full grid-cols-3 sticky top-0 bg-transparent z-10 p-4 border-b rounded-none h-auto gap-2">
            <TabsTrigger
              value="info"
              className="data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-lg rounded-md p-2 text-sm font-semibold transition-all"
            >
              সাধারণ তথ্য
            </TabsTrigger>
            <TabsTrigger
                        ...
                        {isEditingInfo ? (
                          <div className="space-y-4">
                            <FormField
                              ...
                              render={({field}) => (
                                <FormItem>
                                  <FormLabel>সাধারণ টেক্সট</FormLabel>
                                  <FormControl>
                                    <Textarea
                                      {...field}
                                      value={field.value || ''}
                    ...
                    <div className="flex justify-end gap-2 mt-4">
                      {isEditingInfo ? (
                        ...
                        <Button
                          ...
                          className="bg-orange-500 hover:bg-orange-600 text-white"
                        >
                          <Pencil className="mr-2 h-4 w-4" /> কেস হিস্ট্রি
                          সম্পাদনা
                        </Button>
                      )}
                    </div>
