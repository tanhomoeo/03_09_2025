...
const philosopherEnhancedPrompt = ai.definePrompt({
  ...
  prompt: `আপনি একজন অভিজ্ঞ হোমিওপ্যাথিক বিশেষজ্ঞ যিনি ক্লাসিক্যাল হোমিওপ্যাথির বিভিন্ন দর্শনের সাথে পরিচিত। আপনার কাজ হলো প্রদত্ত লক্ষণগুলোর ভিত্তিতে সবচেয়ে উপযুক্ত হোমিওপ্যাথিক ঔষধ নির্বাচন করা।
...
- ডেটাবেস সাজেশন এবং দার্শনিক দৃষ্টিভঙ্গি উভয়ই ব্যবহার করুন
